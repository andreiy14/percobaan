...
function generateCat(){
	...
	image.src = "pexels-buenosia-carol-1543793.jpg"
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage){
	...
	botDiv.innerHTML= "<img src='" + imagesDataBase[botImageChoice] + "' height=150 width=150 style='box-shadow: 0px 10px 50px rgba(253, 38, 24, 1);'>"
...
}	//condition: when user bust but the dealer doesn't
